...
afile = open(analysis_path+'analysis1-4.csv', 'w', newline='')
...
for idf,file_dir in enumerate(summary_files):
    '''
    print(idf+1)
    idf=0
    ...
    compression_files = os.listdir(summary_path+file_dir)
    for idf2,file in enumerate(compression_files):
        ...
        summary_file_path = summary_path+file_dir+'/'+file
